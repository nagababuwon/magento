 ...
 */
namespace Funimation\Catalog\Model\Product\Attribute\Backend\TierPrice;
...
use Funimation\Catalog\Model\ResourceModel\Product\Attribute\Backend\Tierprice;
...
class UpdateHandler implements ExtensionInterface
{
     ...
     * @param \Funimation\Catalog\Model\ResourceModel\Product\Attribute\Backend\Tierprice $tierPriceResource
     */
    ...
    public function execute($entity, $arguments = [])
    {
        ...
        if (null !== $priceRows) {
            ...
            $isGlobal = 0; //$attribute->isScopeGlobal() || $websiteId === 0;
